...
import 'package:nutriscan/services/export/pdf_export_service.dart';
...
class _AnalysisScreenState extends State<AnalysisScreen>
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              labelStyle: themeProvider.getFontForCurrentLanguage(
                fontWeight: FontWeight.bold,
                fontSize: 13,
              ),
              tabs: const [
            ...
            actions: [
              IconButton(
                ...
                onPressed: () {
                  ...
                  if (foods.isNotEmpty) {
                    PdfExportService.exportNutritionReport(foods);
                  } else {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('No logged meals to export.')),
                    );
                  }
                },
              ),
  ...
  List<Food> _filterFoodsByPeriod(List<Food> foods, String period) {
    ...
    return foods.where((food) => !food.analyzedAt.isBefore(startDate)).toList();
  }
